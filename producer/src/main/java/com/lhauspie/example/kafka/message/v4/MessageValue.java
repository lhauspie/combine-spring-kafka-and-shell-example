 ...
 */
package com.lhauspie.example.kafka.message.v4;
...
public class MessageValue extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MessageValue(CharSequence orgId, CharSequence objectId, CharSequence code, CharSequence label, java.time.Instant dateTime) {
    this.orgId = orgId;
  ...
  public void put(int field$, Object value$) {
    ...
    case 4: dateTime = (java.time.Instant)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MessageValue>
    ...
    public MessageValue build() {
      try {
        ...
        record.dateTime = fieldSetFlags()[4] ? this.dateTime : (java.time.Instant) defaultValue(fields()[4]);
        return record;
